                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.location_on, size: 16, color: Color(0xFF33AD60)),
                                    SizedBox(width: 5),
                                    Text(
                                      parking['Location'] ?? '',
                                      style: TextStyle(
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.attach_money, size: 16, color: Color(0xFF33AD60)),
                                    SizedBox(width: 5),
                                    Text(
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.date_range, size: 16, color: Color(0xFF33AD60)),
                                    SizedBox(width: 5),
                                    Text(
                                      parking['startDate'] != null
                                          ? "Start Date: ${DateFormat('MM/dd/yyyy HH:mm').format(parking['startDate'].toDate())}"
